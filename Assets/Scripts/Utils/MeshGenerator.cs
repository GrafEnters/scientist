...
public class MeshGenerator {
            ...
            for (int x = 0; x < cubes.GetLength(0); x++) {
                for (int y = 0; y < cubes.GetLength(1); y++) {
                    for (int z = 0; z < cubes.GetLength(2); z++) {
                        cubes[x, y, z] = new Cube(controlNodes[x * squareSize, y * squareSize, z * squareSize],
                            controlNodes[x * squareSize, y * squareSize, (z + 1) * squareSize],
                            controlNodes[(x + 1) * squareSize, y * squareSize, (z + 1) * squareSize],
                            controlNodes[(x + 1) * squareSize, y * squareSize, z * squareSize],
                            controlNodes[x * squareSize, (y + 1) * squareSize, z * squareSize],
                            controlNodes[x * squareSize, (y + 1) * squareSize, (z + 1) * squareSize],
                            controlNodes[(x + 1) * squareSize, (y + 1) * squareSize, (z + 1) * squareSize],
                            controlNodes[(x + 1) * squareSize, (y + 1) * squareSize, z * squareSize]);
                    }
                }
            }
        }
    ...
    public class Cube {
        ...
        public Cube(ControlNode c0, ControlNode c1, ControlNode c2, ControlNode c3, ControlNode c4, ControlNode c5, ControlNode c6,
            ControlNode c7) {
